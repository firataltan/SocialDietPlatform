        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NutritionalInfo_Calories = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
                    NutritionalInfo_Protein = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
                    NutritionalInfo_Carbohydrates = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
                    NutritionalInfo_Fat = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
                    NutritionalInfo_Fiber = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
                    NutritionalInfo_Sugar = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetCalories = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DietPlans_EndDate",
                table: "DietPlans",
                column: "EndDate");

            migrationBuilder.CreateIndex(
                name: "IX_DietPlans_StartDate",
                table: "DietPlans",
                column: "StartDate");
